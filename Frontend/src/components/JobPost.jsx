...
const JobPost = () => {
    ...
    const cities = [
      ...
      const handlePostJob = (e) => {
        ...
        companyWebsiteTitle &&
          formData.append("companyWebsiteTitle", companyWebsiteTitle);
        companyWebsiteUrl &&
  ...
  <input
    type="number"
    value={vacancies}
    onChange={(e) => setVacancies(e.target.value)} // Update vacancies state
  ...
  />
      ...
      <div>
        <div className="label-infoTag-wrapper">
          <label>Company Website Link (URL)</label>
          <span>
            <CiCircleInfo /> Optional
          </span>
        </div>
